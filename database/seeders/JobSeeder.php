...
Modern office environment',
                'job_type' => 'Full Time',
                'category_id' => JobCategory::where('slug', 'it-software')->first()->id,
...
Flexible schedule',
                'job_type' => 'Full Time',
                'category_id' => JobCategory::where('slug', 'marketing')->first()->id,
                'location' => 'Dar es Salaam, Tanzania',
...
Shift differentials',
                'job_type' => 'Full Time',
                'category_id' => JobCategory::where('slug', 'healthcare')->first()->id,
                'location' => 'Dar es Salaam, Tanzania',
                'experience_level' => 'Mid Level',
...
Modern office facilities',
                'job_type' => 'Full Time',
                'category_id' => JobCategory::where('slug', 'finance')->first()->id,
                'location' => 'Dar es Salaam, Tanzania',
                'experience_level' => 'Mid Level',
...
Equipment provided',
                'job_type' => 'Remote',
                'category_id' => JobCategory::where('slug', 'customer-service')->first()->id,
...
Career growth opportunities',
                'job_type' => 'Full Time',
                'category_id' => JobCategory::where('slug', 'human-resources')->first()->id,
                'location' => 'Dar es Salaam, Tanzania',
                'experience_level' => 'Entry Level',
...
Sales training',
                'job_type' => 'Full Time',
                'category_id' => JobCategory::where('slug', 'sales')->first()->id,
                'location' => 'Dar es Salaam, Tanzania',
                'experience_level' => 'Mid Level',
...
Vehicle allowance',
                'job_type' => 'Full Time',
                'category_id' => JobCategory::where('slug', 'engineering')->first()->id,
                'location' => 'Dar es Salaam, Tanzania',
                'experience_level' => 'Senior Level',
...
Friendly environment',
                'job_type' => 'Part Time',
                'category_id' => JobCategory::where('slug', 'administration')->first()->id,
                'location' => 'Dar es Salaam, Tanzania',
                'experience_level' => 'Entry Level',
