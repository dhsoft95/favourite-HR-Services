                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text"
                                   ...
                                   class="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-transparent transition duration-200 placeholder-gray-400">
