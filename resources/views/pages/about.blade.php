...
@section('content')
    <section class="relative h-[400px] lg:h-[450px] overflow-hidden">
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat"
             style="background-image: url('/images/about/about-bg.jpg');">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div class="group cursor-pointer">
                    <div class="relative bg-gradient-to-br from-gray-300 to-gray-500 rounded-3xl overflow-hidden aspect-[3/4] mb-6 shadow-lg group-hover:shadow-2xl transition-all duration-500">
                        <img src="/images/team/team.jpg"
                             alt="John Doe"
                             class="w-full h-full object-cover transition-all duration-500 group-hover:scale-110">
                        <!-- Overlay on hover -->
                        <div class="absolute inset-0 bg-[#2A2D5A]/0 group-hover:bg-[#2A2D5A]/10 transition-all duration-300"></div>
                    </div>
                    <div class="text-center group-hover:transform group-hover:-translate-y-1 transition-all duration-300">
                        <h3 class="text-xl font-bold text-[#2A2D5A] mb-2 group-hover:text-[#1f2347] transition-colors">John Doe</h3>
                        <p class="text-gray-600 mb-1 font-medium">Managing Director</p>
                        <p class="text-sm text-gray-500">15+ years experience in HR consulting</p>
                        <!-- Skill tags -->
                        <div class="flex flex-wrap justify-center gap-2 mt-3">
                            <span class="px-3 py-1 bg-[#2A2D5A]/10 text-[#2A2D5A] text-xs rounded-full font-medium">Leadership</span>
                            <span class="px-3 py-1 bg-[#2A2D5A]/10 text-[#2A2D5A] text-xs rounded-full font-medium">Strategy</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="group cursor-pointer">
                    ...
                    <div class="text-center group-hover:transform group-hover:-translate-y-1 transition-all duration-300">
                        <h3 class="text-xl font-bold text-[#2A2D5A] mb-2 group-hover:text-[#1f2347] transition-colors">Jane Smith</h3>
                        <p class="text-gray-600 mb-1 font-medium">HR Director</p>
                        <p class="text-sm text-gray-500">12+ years in talent management</p>
                        <div class="flex flex-wrap justify-center gap-2 mt-3">
                            <span class="px-3 py-1 bg-[#2A2D5A]/10 text-[#2A2D5A] text-xs rounded-full font-medium">Recruitment</span>
                            <span class="px-3 py-1 bg-[#2A2D5A]/10 text-[#2A2D5A] text-xs rounded-full font-medium">Training</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="group cursor-pointer">
                    ...
                    <div class="text-center group-hover:transform group-hover:-translate-y-1 transition-all duration-300">
                        <h3 class="text-xl font-bold text-[#2A2D5A] mb-2 group-hover:text-[#1f2347] transition-colors">Michael Johnson</h3>
                        <p class="text-gray-600 mb-1 font-medium">Senior Consultant</p>
                        <p class="text-sm text-gray-500">10+ years in organizational development</p>
                        <div class="flex flex-wrap justify-center gap-2 mt-3">
                            <span class="px-3 py-1 bg-[#2A2D5A]/10 text-[#2A2D5A] text-xs rounded-full font-medium">Development</span>
                            <span class="px-3 py-1 bg-[#2A2D5A]/10 text-[#2A2D5A] text-xs rounded-full font-medium">Analytics</span>
                        </div>
                    </div>
                </div>
            </div>
